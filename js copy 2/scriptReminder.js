...
document.addEventListener('DOMContentLoaded', function() {
    function updateFormFields(method) {
        ...
        document.getElementById('sekolahSiswa').style.display = 'none';
        document.getElementById('kelas').style.display = 'none';
        document.getElementById('sekolahFieldSiswa').classList.add('hidden')
        document.getElementById('sekolahField').classList.remove('hidden')
        ...
        if (method === 'SEND_SISWA') {
            document.getElementById('sekolahSiswa').style.display = 'block';
            document.getElementById('sekolahSiswa').classList.remove('hidden');
            document.getElementById('sekolah').classList.add('hidden');
            document.getElementById('sekolahField').classList.add('hidden')
            document.getElementById('sekolahFieldSiswa').classList.remove('hidden')
            document.getElementById('siswa').style.display = 'block';
        } else if (method === 'SEND_KELAS') {
    
            document.getElementById('sekolahSiswa').classList.add('hidden')
            document.getElementById('sekolah').style.display = 'block';
            document.getElementById('sekolah').classList.remove('hidden');
